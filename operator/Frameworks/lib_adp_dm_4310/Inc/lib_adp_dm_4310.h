...
inline constexpr fp32 DM4310_POS_RAD_MIN = -3.2f;
inline constexpr fp32 DM4310_POS_RAD_MAX =  3.2f;
inline constexpr fp32 DM4310_POS_RAW_STEP =
    (DM4310_POS_RAD_MAX - DM4310_POS_RAD_MIN) / 65535.0f;

inline constexpr fp32 DM4310_PosRawToRad(uint16_t pos_raw)
{
  return static_cast<fp32>(static_cast<fp32>(pos_raw) * DM4310_POS_RAW_STEP +
                           DM4310_POS_RAD_MIN);
}

inline constexpr uint16_t DM4310_PosRawToU16(int16_t pos_raw)
{
  return static_cast<uint16_t>(pos_raw);
}
