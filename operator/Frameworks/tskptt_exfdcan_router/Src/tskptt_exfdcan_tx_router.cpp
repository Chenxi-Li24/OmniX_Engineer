...
// ---- Optional adapter headers (allow per-project availability) ----
#ifndef EXFDCAN_HAS_ADP_DJI_C620
  #if defined(__has_include)
    #if __has_include("lib_adp_dji_c620.h")
      #define EXFDCAN_HAS_ADP_DJI_C620 1
    #endif
  #endif
#endif
#ifndef EXFDCAN_HAS_ADP_DJI_C620
  #define EXFDCAN_HAS_ADP_DJI_C620 0
#endif
#if !EXFDCAN_HAS_ADP_DJI_C620
  #warning "EXFDCAN: lib_adp_dji_c620.h not found; C620 adapter disabled."
#endif

#ifndef EXFDCAN_HAS_ADP_DJI_GM6020
  #if defined(__has_include)
    #if __has_include("lib_adp_dji_gm6020.h")
      #define EXFDCAN_HAS_ADP_DJI_GM6020 1
    #endif
  #endif
#endif
#ifndef EXFDCAN_HAS_ADP_DJI_GM6020
  #define EXFDCAN_HAS_ADP_DJI_GM6020 0
#endif
#if !EXFDCAN_HAS_ADP_DJI_GM6020
  #warning "EXFDCAN: lib_adp_dji_gm6020.h not found; GM6020 adapter disabled."
#endif

#ifndef EXFDCAN_HAS_ADP_DM_4310
  #if defined(__has_include)
    #if __has_include("lib_adp_dm_4310.h")
      #define EXFDCAN_HAS_ADP_DM_4310 1
    #endif
  #endif
#endif
#ifndef EXFDCAN_HAS_ADP_DM_4310
  #define EXFDCAN_HAS_ADP_DM_4310 0
#endif
#if !EXFDCAN_HAS_ADP_DM_4310
  #warning "EXFDCAN: lib_adp_dm_4310.h not found; DM4310 adapter disabled."
#endif

#ifndef EXFDCAN_HAS_ADP_DM_4340
  #if defined(__has_include)
    #if __has_include("lib_adp_dm_4340.h")
      #define EXFDCAN_HAS_ADP_DM_4340 1
    #endif
  #endif
#endif
#ifndef EXFDCAN_HAS_ADP_DM_4340
  #define EXFDCAN_HAS_ADP_DM_4340 0
#endif
#if !EXFDCAN_HAS_ADP_DM_4340
  #warning "EXFDCAN: lib_adp_dm_4340.h not found; DM4340 adapter disabled."
#endif
  ...
  #warning "EXFDCAN: lib_adp_lk_mg8016e.h not found; LK8016E adapter disabled."
#endif
...

    {
        ...
        for (int i = 0; i < EXCANTX_MAX_DM_RAW8; ++i) {
            ...
            if (o.query(o.obj, &sid, buf)) {
                // NOTE: Some DM4310 firmwares accept only DLC=8 even in Velocity mode.
                // Keep default DLC=8 for compatibility; if you need DLC=4 (reference speed_ctrl()),
                // build with -DDM4310_VELOCITY_DLC_4=1.
                uint8_t dlc = 8;
#if EXFDCAN_HAS_ADP_DM_4310
                if (o.query == query_dm4310_raw8) {
                    DM4310* m = reinterpret_cast<DM4310*>(o.obj);
                    if (m && m->mode() == DM4310Mode::Velocity) {
#if defined(DM4310_VELOCITY_DLC_4) && (DM4310_VELOCITY_DLC_4)
                        dlc = 4;
#endif
                    }
                }
                ...
                for (;;) {
                    if (exfdcan_tx_push(dev, ex_ctx, sid, buf, dlc)) {
                        break;
                    }
...
#else
                (void)exfdcan_tx_push(dev, ex_ctx, sid, buf, dlc);
#endif
            }
