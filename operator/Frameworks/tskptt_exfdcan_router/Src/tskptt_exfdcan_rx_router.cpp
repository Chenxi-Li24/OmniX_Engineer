...
// ---- Optional adapter headers (allow per-project availability) ----
  ...
  #warning "EXFDCAN: lib_adp_navision.h not found; Navision adapter disabled."
#endif
  ...
  #warning "EXFDCAN: lib_adp_omximu.h not found; OmxImu adapter disabled."
#endif
...
#define EXFDCAN_RX_LOG_EVERY   (10000u)
#endif
