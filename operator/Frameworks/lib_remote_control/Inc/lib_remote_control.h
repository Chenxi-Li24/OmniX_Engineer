...
/* VT03 proxy key mapping: Ctrl key is used for pause/self-lock recovery (instead of X). */
#define KEY_PROXY_VT03_CAPSLOCK   KEY_PRESSED_OFFSET_CTRL
/* VT03 proxy key mapping: Space is currently sent as Shift key. */
#define KEY_PROXY_VT03_SPACE      KEY_PRESSED_OFFSET_SHIFT
...
/* 默认优先级（可在运行时修改） */
#define RC_PRI_DEFAULT_PRIMARY    RC_SRC_VT03
#define RC_PRI_DEFAULT_SECONDARY  RC_SRC_DR16
