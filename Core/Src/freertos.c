...
/* Definitions for SerialServo_Task */
osThreadId_t SerialServo_TaskHandle;
const osThreadAttr_t SerialServo_Task_attributes = {
  .name = "SerialServo_Task",
  .stack_size = 768 * 4,
...
void MX_FREERTOS_Init(void) {
  ...
  /* creation of SerialServo_Task */
  SerialServo_TaskHandle = osThreadNew(Start_SerialServo_Task, NULL, &SerialServo_Task_attributes);
