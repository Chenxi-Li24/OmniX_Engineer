...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
  ...
  /* USER CODE BEGIN UART9_MspInit 1 */
  {
    ...
    /* H12H on UART9 is single-wire half-duplex: keep TX only, OD + pull-up. */
    ...
    /* Half-duplex bus does not use the RX pad; avoid residual push-pull config. */
  ...
  {
    GPIO_InitTypeDef gpio_init = {0};
    /* H12H on USART6 is single-wire half-duplex: OD + pull-up keeps idle high. */
